...
interface AuditGroupEditorProps {
  poolId: string;
  rounds: Round[];
...
export function AuditGroupEditor({
  poolId,
  rounds,
  pendingChanges,
  onAddChange,
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Editar Grupos</CardTitle>
        </CardHeader>
            ...
            <div className="space-y-4">
              ...
              {loading ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  Nenhum jogo encontrado neste grupo.
                </div>
              ) : (
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              ...
                              <span className={homeChange ? 'line-through text-muted-foreground' : ''}>
                                {match.home_team}
                              </span>
                              {homeChange && (
                          ...
                          <div className="flex-1 text-right">
                            <div className="flex items-center justify-end gap-2">
                              ...
                              <span className={awayChange ? 'line-through text-muted-foreground' : ''}>
                                {match.away_team}
                              </span>
      ...
      <Dialog open={renameDialogOpen} onOpenChange={setRenameDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Altere o nome do grupo. Isso não afeta os jogos ou pontuações.
            </DialogDescription>
          </DialogHeader>
