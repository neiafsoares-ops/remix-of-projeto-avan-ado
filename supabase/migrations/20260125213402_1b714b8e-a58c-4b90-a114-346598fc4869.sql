...
DROP FUNCTION IF EXISTS public.is_suggested_pool_moderator(UUID, UUID);
DROP FUNCTION IF EXISTS public.can_edit_suggested_pool_matches(UUID, UUID);
...
-- 5. POLÍTICAS RLS - suggested_pools
-- =====================================================
...
-- 6. POLÍTICAS RLS - suggested_pool_moderators
-- =====================================================
...
-- 7. POLÍTICAS RLS - suggested_pool_rounds
-- =====================================================
...
-- 8. POLÍTICAS RLS - suggested_pool_matches
-- =====================================================
...
-- 9. POLÍTICAS RLS - mestre_pool_instances
-- =====================================================
